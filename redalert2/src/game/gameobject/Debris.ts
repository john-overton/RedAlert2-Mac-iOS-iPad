...
export class Debris extends GameObject {
    ...
    private detonate(gameContext: any, collisionType: CollisionType = CollisionType.None): void {
        ...
        if (warhead) {
            ...
            warheadInstance.detonate(gameContext, this.rules.damage, this.tile, this.tileElevation, this.position.worldPosition, this.zone, collisionType, gameContext.createTarget(undefined, this.tile), undefined, false, undefined, this.rules.damageRadius || undefined);
        }
    }
}
