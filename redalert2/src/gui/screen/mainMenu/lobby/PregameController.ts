...
export class PregameController {
    ...
    private buildAvailableAiNames(): Map<string, string> {
        ...
        // Normal first, so new AI slots default to a real opponent. Easy/Normal/
        // Brutal are the built-in bot at different profiles; Medium is the
        ...
        names.set('Medium', aiUiNames.get(AiDifficulty.Medium)!);
