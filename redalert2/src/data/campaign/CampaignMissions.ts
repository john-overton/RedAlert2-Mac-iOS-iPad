...
export const campaignMissions = [
    {sourceGame:'ra2', id:'allied-01', map:'all01t.map', title:'Lone Guardian', label:'Mission One', briefing:'Brief:ALL01', next:'allied-02'},
    {sourceGame:'ra2', id:'allied-02', map:'all02s.map', title:'Eagle Dawn', label:'Mission Two', briefing:'Brief:ALL02', next:undefined},
] as const;
...
export function campaignAssetPath(mission: CampaignMission, file: string): string {
    return `campaign/${mission.sourceGame}/${mission.id}/${file}`;
}
