...
const identity = { protocol: 2, ordersProtocol: 2, engine: 'yr' as const, mod: 'base', version: 'mac-host-smoke', modHash: 'rules', assetFingerprint: 'retail' };
...
try {
    ...
    console.log('Host/guest, password rejection, chat, match start and host departure passed.');
